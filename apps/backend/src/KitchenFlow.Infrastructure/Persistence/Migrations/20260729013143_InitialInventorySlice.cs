        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_lots_quantity_mode", "(measured_value IS NOT NULL AND measured_unit IS NOT NULL AND availability_state IS NULL) OR (measured_value IS NULL AND measured_unit IS NULL AND availability_state IS NOT NULL)");
                });
