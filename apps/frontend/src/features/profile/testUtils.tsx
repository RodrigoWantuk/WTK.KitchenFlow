...
export function createConfirmedProfileSnapshot(
  ...
  return {
    ...
    cookingContext: {
      overallSkill: field("Intermediate"),
      confidence: field("Confident"),
      preferredInstructionDetail: field("Standard"),
      ordinaryPrepMinutes: field(30),
      exceptionalPrepMinutes: field(90),
      effortTolerance: field("Moderate"),
      cleanupTolerance: field("Moderate"),
      repeatMealPreference: field("Sometimes"),
      reheatingPreference: field("Often"),
      leftoverPreference: field("Often"),
      freezingPreference: field("Sometimes"),
    },
    adultDeclaration: {
      adultDeclared: true,
      termsVersion: "v1",
