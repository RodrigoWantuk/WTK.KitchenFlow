...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0016](plans/PLAN-0016-define-ai-recipe-artifact-protocol.md) | Define AI Recipe Artifact Protocol and Model Evaluation Pack | Documentation | Draft | Draft PR #23 | Stakeholder + AI architecture collaboration | `docs/plan-0016-ai-recipe-artifacts` / PR #23 | Compact system prompt, complete snapshots, inventory usage modes, and required/excluded ingredient/equipment constraints documented in protocol 0.2 draft | Stakeholder reruns low-cost model comparisons using system prompt + updated JSON examples | Stakeholder decisions on snapshot limits, schemas, budgets, and preferred model behavior | 2026-08-01T17:43:00Z |
