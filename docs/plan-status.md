...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0020](plans/PLAN-0020-implement-profile-household-equipment-frontend.md) | Implement Profile, Household, Preferences, and Equipment Frontend | Implementation | In Progress | Draft [PR #35](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/35) remediation | PLAN-0020 remediation agent | `agent/plan-0020-profile-frontend` / #35 | Reopened after PLAN-0024 Fail @ `5733bb4`; remediating F-0024-01…05 | Implement remediations; publish new green candidate for PLAN-0025 | #37 (awaiting remediation + retest) | 2026-08-03 |
