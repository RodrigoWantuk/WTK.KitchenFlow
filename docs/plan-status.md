...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0020](plans/PLAN-0020-implement-profile-household-equipment-frontend.md) | Implement Profile, Household, Preferences, and Equipment Frontend | Implementation | In Progress | Draft [PR #35](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/35) | Cursor agent (PLAN-0020 remediation) | `agent/plan-0020-profile-frontend` @ review `a50152c` | PR #35 remediation R1–R12 in progress | Commit; local gates; push; exact-head CI | Acceptance defects vs baseline | 2026-08-03 |
| [PLAN-0024](plans/PLAN-0024-independently-validate-plan-0020-profile-frontend.md) | Independently Validate PLAN-0020 Profile Frontend | Testing | Draft | Not started | Unassigned independent testing agent | `agent/plan-0024-validate-plan-0020-profile` | Unpinned — wait for remediation candidate | Pin only after PLAN-0020 remediation tip is final and green | PLAN-0020 remediation incomplete | 2026-08-03 |
