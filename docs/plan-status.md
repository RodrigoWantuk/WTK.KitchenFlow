...
| [PLAN-0023](plans/PLAN-0023-implement-prepared-components-and-derived-lots.md) | Implement Prepared Components and Derived Inventory Lots | Implementation | Validating | Draft [PR #39](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/39) | Codex backend/domain implementation agent | `agent/plan-0023-prepared-component-lots` | Replacement candidate `9bff2e1` passed exact-head CI after F-0026-01/02/03 remediation | Independent PLAN-0027 retest | Awaiting PLAN-0027 assessment | 2026-08-05T14:15:00Z |
| [PLAN-0027](plans/PLAN-0027-independently-retest-prepared-component-remediation.md) | Independently Retest Prepared-Component Remediation | Testing | In Progress | Draft validation PR opening; SUT `9bff2e130afb4a0f31ea0b84925362f546d1179e` | Independent validation agent (PLAN-0027) | `agent/plan-0027-retest-prepared-components` | Claimed; packaging-head docs-only delta verified; adversarial matrix not yet executed | Open draft validation PR and execute remediation/non-regression matrix against detached SUT | None at claim | 2026-08-05T15:00:47Z |
