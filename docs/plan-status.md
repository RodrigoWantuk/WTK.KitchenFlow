...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) · [amendment](plans/PLAN-0011-amendment-2026-08-02-next-execution.md) | Implement the Public Entry and Contextual Home Experience | Implementation | In Progress | Implementation commit pending draft PR | Cursor agent (PLAN-0011 Phase 1 + Phase 2) | `agent/plan-0011-contextual-home` | Phase 1+2 code complete locally; public entry + mock home + isolation + tests | Push, open draft PR to `RodrigoWantuk`, wait for CI | None for amended scope; live contracts = PLAN-0021 | 2026-08-02 |
