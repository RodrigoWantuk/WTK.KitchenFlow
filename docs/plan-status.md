...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0028](plans/PLAN-0028-implement-recipe-ai-gateway-and-generation.md) | Implement Recipe AI Gateway and Cook-Now Generation Vertical Slice | Implementation | In Progress | Draft [PR #44](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/44) | Cursor backend/frontend vertical-slice agent | `agent/plan-0028-recipe-ai-gateway` | Roadmap reconciled; AI/Recipes scaffold in progress | Complete cook-now API, frontend, OpenAPI, focused tests, final CI | None | 2026-08-05 |
