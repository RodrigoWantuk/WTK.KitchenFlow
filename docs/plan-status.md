...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0014](plans/PLAN-0014-integrate-emergent-frontend.md) | Integrate Emergent Frontend and Establish Production Frontend Baseline | Implementation | In Progress | [Draft PR #14](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/14) | Cursor agent | `agent/plan-0014-integrate-emergent-frontend` / #14 | Phases 0–7 done; Phase 8 full JS→TS migration planned, not started | Execute Phase 8a (TS ESLint + guard/README), then 8b lib/store | None | 2026-07-31T22:05:41Z |
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Blocked | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | Accepted product behavior fully specified; waits for PLAN-0014 baseline | After PLAN-0014 baseline, claim and implement Phase 1 plus mock-backed Phase 2 | PLAN-0014 frontend baseline; live menu/profile/inventory-attention/recommendation contracts | 2026-07-31T20:15:00Z |
| [PLAN-0005](plans/PLAN-0005-test-authenticated-inventory-slice.md) | Independently Validate the Authenticated Inventory Slice | Testing | Ready | Backend merged; frontend and integration pending | Unassigned independent test agent | `agent/plan-0005-test-inventory-slice` | PLAN-0003 backend merged; frontend baseline redirected to PLAN-0014 | Assign independent tester after PLAN-0014 baseline; pin frontend SHA | Stable PLAN-0014 frontend baseline | 2026-07-31T20:15:00Z |
