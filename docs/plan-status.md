...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0020](plans/PLAN-0020-implement-profile-household-equipment-frontend.md) | Implement Profile, Household, Preferences, and Equipment Frontend | Implementation | In Progress | Draft [PR #35](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/35) | Cursor agent (PLAN-0020 residual remediation) | `agent/plan-0020-profile-frontend` | Residual nav/post-save UX vs baseline `9df4ec9` | Validate, push, exact-head CI; then Complete + pin PLAN-0024 | None | 2026-08-03 |
| [PLAN-0024](plans/PLAN-0024-independently-validate-plan-0020-profile-frontend.md) | Independently Validate PLAN-0020 Profile Frontend | Testing | Draft | Not started | Unassigned independent testing agent | `agent/plan-0024-validate-plan-0020-profile` | Unpinned; prior `f59606e` superseded by residual remediation | Wait for residual candidate; then Ready + pin | Waiting on PLAN-0020 residual tip | 2026-08-03 |
