...
| [PLAN-0023](plans/PLAN-0023-implement-prepared-components-and-derived-lots.md) | Implement Prepared Components and Derived Inventory Lots | Implementation | PR #39 — PLAN-0027 incorporated; consolidated CI passed at `99d84da`; final documentation-head checks gate owner review | Completed after PLAN-0027 **Pass** at `9bff2e1` | 2026-08-05 |
