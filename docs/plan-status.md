...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0016](plans/PLAN-0016-define-ai-recipe-artifact-protocol.md) | Define AI Recipe Artifact Protocol and Model Evaluation Pack | Documentation | Draft | Draft PR | Stakeholder + AI architecture collaboration | `docs/plan-0016-ai-recipe-artifacts` | Initial two-operation protocol and seven JSON benchmark requests created | Stakeholder runs examples against candidate models and annotates desired/undesired behavior | Stakeholder decisions on schemas, limits, budgets, and model behavior | 2026-08-01T17:00:00Z |
