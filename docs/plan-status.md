...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0012](plans/PLAN-0012-implement-profile-household-equipment-backend.md) | Implement Account, Household, Profile and Equipment Backend Slice | Implementation | In Progress | PR open | Cursor cloud agent | `cursor/plan-0012-profile-backend-1672` | Remediation in progress: concurrency, PUT semantics, validation, privacy redaction, equipment identity, collection ETags | Finish remediation tests, validate CI, update PR | None | 2026-07-31T22:30:00Z |
...
| [PLAN-0004](plans/PLAN-0004-implement-lovable-inventory-ux.md) | Implement Lovable Application Shell and Inventory UX | Implementation | Ready | Not started | Unassigned Lovable/frontend agent | `agent/plan-0004-lovable-inventory-ux` | Technical workflow and refined design brief are specified; Layer A inventory and Layer B broad mock prototype are separated | Owner creates the dedicated Lovable project/repository and the frontend agent claims the plan | Owner Lovable setup | 2026-07-31T18:45:00Z |
| [PLAN-0005](plans/PLAN-0005-test-authenticated-inventory-slice.md) | Independently Validate the Authenticated Inventory Slice | Testing | Ready | Backend merged; frontend and integration pending | Unassigned independent test agent | `agent/plan-0005-test-inventory-slice` | PLAN-0003 backend merged to `main` at `f9d4293`; independent execution not started | Assign independent tester; pin PLAN-0004 frontend baseline before integrated validation | Stable PLAN-0004 frontend baseline | 2026-07-31T18:45:00Z |
...
|---|---|---|---|---|---|
| [PLAN-0013](plans/PLAN-0013-define-closed-loop-kitchen-orchestration.md) | Define Closed-Loop Kitchen Orchestration | Documentation | [Draft PR #13 open](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/13) | Accepted localized recovery, prepared-component inventory, sequential planning simulation, reconciliation, uncertainty, controlled troubleshooting learning, and multi-day preparation dependency routes with explicit responsibility boundaries | 2026-07-31 |
