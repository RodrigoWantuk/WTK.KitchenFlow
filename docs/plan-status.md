...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0018](plans/PLAN-0018-independent-retest-plan-0016.md) | Independently Retest PLAN-0016 Authenticated Inventory Remediations | Testing | In Progress | Draft PR pending (target: PLAN-0016 branch) | agent:independent-retest-plan-0018 | `agent/plan-0018-independent-retest-plan-0016` from SUT `814af25` | Plan registered; SUT pin verified; Phase 1 starting | Run independent gates + integrated Keycloak/inventory/Firefox zoom evidence | None yet; PR #23 untouched; PLAN-0017 reserved | 2026-08-02 |
| [PLAN-0016](plans/PLAN-0016-implement-production-session-and-inventory-frontend.md) | Implement Production Session and Authenticated Inventory Frontend | Implementation | Validating | [Draft PR #25](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/25) — tip `814af25`; Frontend CI `30728413882` | agent:composer-plan-0016 | `agent/plan-0016-production-inventory-frontend` @ `814af25` | Awaiting independent PLAN-0018 assessment | Do not merge until PLAN-0018 outcome + owner decision | Independent retest in PLAN-0018; PLAN-0005 Conditional Pass; PLAN-0011 Blocked; PR #23 → later PLAN-0017 | 2026-08-02 |
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Blocked | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | PLAN-0015 Completed (manual checks deferred non-blocking); waiting on PLAN-0016 + independent PLAN-0005 retest | Do not start until PLAN-0016 remediation candidate passes independent retest | PLAN-0016 delivery + independent revalidation of #20/#21/#22/#24 | 2026-08-02 |
...
|---|---|---|---|---|---|
| [PLAN-0005](plans/PLAN-0005-test-authenticated-inventory-slice.md) | Independently Validate the Authenticated Inventory Slice | Testing | **Merged** via [PR #19](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/19) at `60d98dd9e2e7c460d670e701c027a44f25cdfedc` (2026-08-01) | **Conditional Pass** (unchanged). Evidence-generation head `cabd2c2`. CI PLAN-0005 `30716628735` / Backend `30716628750` / Frontend `30716628760`. Artifacts P0 `8823586490` / P1 `8823580211` / consistency `8823588906`. Residual: High #20, Medium #21/#22, coverage #24. Remediation owned by PLAN-0016; independent retest required before Pass. | 2026-08-01 |
