...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0012](plans/PLAN-0012-implement-profile-household-equipment-backend.md) | Implement Account, Household, Profile and Equipment Backend Slice | Implementation | Validating | PR open (draft) | Cursor cloud agent | `cursor/plan-0012-profile-backend-1672` | Profile module, API, migration, OpenAPI, and 127 tests green locally | Push candidate, reconcile CI, independent review, mark PR ready | None | 2026-07-31T19:10:00Z |
