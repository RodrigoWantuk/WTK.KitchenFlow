...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0020](plans/PLAN-0020-implement-profile-household-equipment-frontend.md) | Implement Profile, Household, Preferences, and Equipment Frontend | Implementation | In Progress | Draft [PR #35](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/35) | Cursor agent (PLAN-0020 remediation) | `agent/plan-0020-profile-frontend` · remediation `6215b89` | Remediation published | Await exact-head CI; Complete + pin PLAN-0024 when green | Exact-head CI pending | 2026-08-03 |
