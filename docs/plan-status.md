...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0020](plans/PLAN-0020-implement-profile-household-equipment-frontend.md) | Implement Profile, Household, Preferences, and Equipment Frontend | Implementation | In Progress | Draft [PR #35](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/35) | Unassigned PLAN-0020 remediation agent | `agent/plan-0020-profile-frontend` / #35 | PLAN-0024 **Fail** at SUT `5733bb4`; P1 F-0024-01/02 | Remediate P1 findings; pin new green candidate; request retest | PLAN-0024 Fail evidence PR #36 | 2026-08-03 |
...
|---|---|---|---|---|---|
| [PLAN-0024](plans/PLAN-0024-independently-validate-plan-0020-profile-frontend.md) | Independently Validate PLAN-0020 Profile Frontend | Testing | Draft [PR #36](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/36) (base `agent/plan-0020-profile-frontend`) | **Fail** at immutable SUT `5733bb4de957b53469a28bc60c472a90f0955907` (P1 F-0024-01/02) | 2026-08-03 |
