...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) · [amendment](plans/PLAN-0011-amendment-2026-08-02-next-execution.md) | Implement the Public Entry and Contextual Home Experience | Implementation | In Progress | Draft [PR #34](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/34) | Cursor agent (PLAN-0011 final remediation) | `agent/plan-0011-contextual-home` @ `b7c213b` | Residual remediations at functional tip; CI pending | Push; await exact-head Frontend + PLAN-0005; keep draft | Exact-head CI pending | 2026-08-02 |
