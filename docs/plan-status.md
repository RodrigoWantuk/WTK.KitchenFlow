...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0016](plans/PLAN-0016-implement-production-session-and-inventory-frontend.md) | Implement Production Session and Authenticated Inventory Frontend | Implementation | In Progress | Not opened | agent:composer-plan-0016 | `agent/plan-0016-production-inventory-frontend` | Phase 0 docs reconciled; implementing generated client + live session/inventory | Generate OpenAPI TS client; replace unavailable session; ship production inventory UI | None | 2026-08-02 |
