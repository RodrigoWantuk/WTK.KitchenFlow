...
|---|---|---|---|---|---|
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) · [amendment](plans/PLAN-0011-amendment-2026-08-02-next-execution.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Draft [PR #34](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/34) awaiting owner merge; CI-validated tip `f3fc22e6edbcbb422ae116c8afc46206ae3ec4e8` | Phase 1+2 + residual remediations complete; Frontend `30761370986` and PLAN-0005 `30761370988` green | 2026-08-02 |
