...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0028](plans/PLAN-0028-implement-recipe-ai-gateway-and-generation.md) | Implement Recipe AI Gateway and Cook-Now Generation Vertical Slice | Implementation | In Progress | Draft PR opening | Cursor backend/frontend vertical-slice agent | `agent/plan-0028-recipe-ai-gateway` | Claimed from `cfec795`; roadmap reconciliation in progress | Implement AI Gateway, Recipes module, cook-now API, and production Recipes UI | None | 2026-08-05 |
