...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0012](plans/PLAN-0012-implement-profile-household-equipment-backend.md) | Implement Account, Household, Profile and Equipment Backend Slice | Implementation | Validating | [PR #12](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/12) / Changes requested | Cursor agent | `cursor/plan-0012-profile-backend-1672` | Privacy redaction enum-based; null missing-profile timestamps; canonical history; nested error paths; unique-equipment migration fail-closed; local 191/191 | Push head; await Backend CI; owner re-review; keep open; do not merge/Complete | Owner re-review | 2026-08-01T08:15:00Z |
| [PLAN-0015](plans/PLAN-0015-remediate-frontend-baseline.md) | Remediate and Validate the Imported Frontend Baseline | Implementation | Validating | Merged via PR #16 | Cursor agent | `agent/plan-0015-remediate-frontend-baseline` (merged) | PR #16 merged 2026-08-01T06:22:00Z; remaining owner/manual frontend validation (e.g. 200% zoom) | Complete remaining manual validation evidence; owner decides Completed | Remaining manual frontend validation | 2026-08-01T08:10:00Z |
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Blocked | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | PLAN-0015 code merged via PR #16; not unblocked until remaining manual validation/owner decision | Resume only after remaining PLAN-0015 manual validation is accepted | Remaining PLAN-0015 manual validation / owner decision | 2026-08-01T08:10:00Z |
| [PLAN-0005](plans/PLAN-0005-test-authenticated-inventory-slice.md) | Independently Validate the Authenticated Inventory Slice | Testing | Ready | Backend merged; frontend merged via PR #16, baseline pin pending remaining PLAN-0015 validation | Unassigned independent test agent | `agent/plan-0005-test-inventory-slice` | PR #16 merged; pin definitive frontend SHA after remaining PLAN-0015 manual validation | After remaining PLAN-0015 validation, pin frontend SHA and start independent testing | Remaining PLAN-0015 manual validation before definitive frontend pin | 2026-08-01T08:10:00Z |
