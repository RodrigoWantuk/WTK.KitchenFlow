...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0022](plans/PLAN-0022-evaluate-and-finalize-recipe-ai-contracts.md) · [lean amendment](plans/PLAN-0022-amendment-2026-08-05-lean-evaluation.md) | Evaluate and Finalize Recipe AI Artifact Contracts | Research | In Progress | Draft PR opening on `agent/plan-0022-recipe-ai-evaluation` | Cursor agent (PLAN-0022 lean evaluation) | `agent/plan-0022-recipe-ai-evaluation` | Lean policy adopted; protocol `0.3` schemas/fixtures/validators/decisions delivered; deterministic tests passed | Export `DEEPSEEK_API_KEY`, run bounded four-call live campaign, record evidence, mark Completed | `DEEPSEEK_API_KEY` missing in agent environment | 2026-08-05 |
