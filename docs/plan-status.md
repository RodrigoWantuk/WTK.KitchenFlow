...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0016](plans/PLAN-0016-define-ai-recipe-artifact-protocol.md) | Define AI Recipe Artifact Protocol and Model Evaluation Pack | Documentation | Validating | Draft PR #23 — awaiting stakeholder model validation | Stakeholder + AI architecture collaboration | `docs/plan-0016-ai-recipe-artifacts` / PR #23 | Protocol 0.3 defines three-candidate generation, `cook_now`, sequential menu planning, projected purchase reuse, reservations, local meal context, preparation reminders, compact sessions and hardened prompt | Run protocol 0.3 fixtures against DeepSeek V4 Flash thinking-high and record streaming/token/latency plus semantic validation | Repeated benchmark evidence, strict-output decision, ingredient identity and package-confidence thresholds | 2026-08-01T21:12:00Z |
| [PLAN-0005](plans/PLAN-0005-test-authenticated-inventory-slice.md) | Independently Validate the Authenticated Inventory Slice | Testing | Ready | Not started | Unassigned independent test agent | `agent/plan-0005-test-inventory-slice` (create after PLAN-0015 completion docs merge) | PLAN-0015 Completed pending PR #18 merge; frontend pin `e248126`; inventory/profile baselines on main | After PR #18 merge, an independent agent claims PLAN-0005, creates its exclusive branch and moves it to In Progress | Wait for owner merge of PR #18 (PLAN-0015 completion) | 2026-08-01T16:00:00Z |
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Blocked | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | Blocked by PLAN-0005; PLAN-0015 Completed pending PR #18 merge | Do not start until PLAN-0015 docs merged and PLAN-0005 automated P0 progress without Critical defects | PLAN-0005 automated validation | 2026-08-01T16:00:00Z |
...
| [PLAN-0003](plans/PLAN-0003-implement-backend-inventory-slice.md) | Implement Backend Foundation and Inventory Core | Implementation | [Merged via PR #9](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/9) (`f9d429346615bf5b157656822057917ca2fe4032`) | Final candidate `d9c67e1` green in CI run 30643543261 with Keycloak smoke and 115 tests | 2026-07-31 |
