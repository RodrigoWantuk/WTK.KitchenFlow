...
| [PLAN-0023](plans/PLAN-0023-implement-prepared-components-and-derived-lots.md) | Implement Prepared Components and Derived Inventory Lots | Implementation | In Progress | Draft [PR #39](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/39) | Codex backend/domain implementation agent | `agent/plan-0023-prepared-component-lots` | F-0026-01/02/03 code, permanent regressions, migration revision, bounded provenance flags, and generated contracts are implemented locally | Run full gates and publish a replacement exact green candidate, then pin PLAN-0027 | Historical PLAN-0026 Fail is immutable; preserve unrelated untracked workspace artifacts | 2026-08-05T13:57:56Z |
| [PLAN-0027](plans/PLAN-0027-independently-retest-prepared-component-remediation.md) | Independently Retest Prepared-Component Remediation | Testing | Draft | Not started | Unassigned independent testing agent | `agent/plan-0027-retest-prepared-components` | Successor retest plan created after PLAN-0026 Fail; SUT remains unpinned | Wait for a replacement exact green PLAN-0023 candidate, then pin and claim independently | Replacement implementation and exact-head CI are pending | 2026-08-05T13:57:56Z |
...
|---|---|---|---|---|---|
| [PLAN-0026](plans/PLAN-0026-independently-validate-prepared-components.md) | Independently Validate Prepared Components and Derived Lots | Testing | Draft PR #40 retained unmerged as immutable historical evidence | **Fail** at SUT `7e24fa2f86350d8a566de0b9f2f1cdba984080ff`; F-0026-01/P1, F-0026-02/P1, F-0026-03/P2 | 2026-08-05T01:48:18Z |
