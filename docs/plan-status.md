...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0002](plans/PLAN-0002-specify-authenticated-inventory-vertical-slice.md) | Specify the First Authenticated Inventory Vertical Slice | Documentation | In Progress | Branch open | AI planning agent | `agent/plan-0002-first-vertical-slice-plans` | Backend, Lovable frontend, and independent-test plans are fully specified | Add canonical Windows/Linux development environment documentation | None | 2026-07-29T00:25:00Z |
