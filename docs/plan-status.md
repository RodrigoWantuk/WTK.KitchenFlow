...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) · [amendment](plans/PLAN-0011-amendment-2026-08-02-next-execution.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Ready | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | PR #25 and PR #32 are on `main`; immediate scope is Phase 1 public entry + Phase 2 mock-backed home only | Claim from current `main`, verify the `AGENTS.md` host workflow, and deliver Phase 1 + Phase 2 as one frontend slice | None for the amended scope; live contracts moved to PLAN-0021 | 2026-08-02 |
| [PLAN-0020](plans/PLAN-0020-implement-profile-household-equipment-frontend.md) | Implement Profile, Household, Preferences, and Equipment Frontend | Implementation | Ready | Not started | Unassigned frontend implementation agent | `agent/plan-0020-profile-frontend` | PLAN-0012 backend/profile APIs and generated contracts are on `main` | Start after PLAN-0011 merge, regenerate the client, and deliver the production profile frontend | Avoid concurrent edits with PLAN-0011 unless file ownership and merge order are explicit | 2026-08-02 |
...
| [PLAN-0023](plans/PLAN-0023-implement-prepared-components-and-derived-lots.md) | Implement Prepared Components and Derived Inventory Lots | Implementation | Ready | Not started | Unassigned backend/domain implementation agent | `agent/plan-0023-prepared-component-lots` | Inventory foundation supports ordinary lots; prepared-component semantics are accepted but unimplemented | Create the independent test-plan placeholder and implement the backend vertical slice | Coordinate generated-contract changes with active frontend plans | 2026-08-02 |
...
|---|---|---|---|---|---|
| [PLAN-0019](plans/PLAN-0019-reconcile-roadmap-and-next-work.md) | Reconcile the Active Roadmap and Define the Next Work Queue | Documentation | Draft roadmap PR from `agent/plan-0019-reconcile-roadmap` | Canonical documentation reviewed; stale delivery truth reconciled; active scopes separated; PLAN-0020 through PLAN-0023 created; PLAN-0011 selected as next assignment | 2026-08-02 |
