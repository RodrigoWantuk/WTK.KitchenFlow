...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Ready | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | PLAN-0014 frontend baseline merged on main | Claim branch and implement Phase 1 plus mock-backed Phase 2 | Live menu/profile/inventory-attention/recommendation contracts | 2026-07-31T22:21:00Z |
| [PLAN-0005](plans/PLAN-0005-test-authenticated-inventory-slice.md) | Independently Validate the Authenticated Inventory Slice | Testing | Ready | Backend merged; frontend and integration pending | Unassigned independent test agent | `agent/plan-0005-test-inventory-slice` | PLAN-0014 frontend baseline merged; ready to pin SHA | Assign independent tester; pin frontend SHA from main | None | 2026-07-31T22:21:00Z |
...
|---|---|---|---|---|---|
| [PLAN-0014](plans/PLAN-0014-integrate-emergent-frontend.md) | Integrate Emergent Frontend and Establish Production Frontend Baseline | Implementation | [Merged via PR #14](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/14) | Official `apps/frontend` baseline from Emergent `69f798f`; shared route/reserved/cook/shopping; Emergent removed; full TS `src/`; frontend CI | 2026-07-31 |
