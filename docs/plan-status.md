...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0017](plans/PLAN-0017-define-ai-recipe-artifact-protocol.md) | Define AI Recipe Artifact Protocol and Model Evaluation Pack | Documentation | Validating | [Merged via PR #31](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/31); execution validation remains open | Stakeholder + AI architecture collaboration | `main` / PR #31 | Protocol 0.3 defines three-candidate generation, `cook_now`, sequential menu planning, projected purchase reuse, preparation reminders and the versioned expanded-recipe `thumbnailVisual` contract consumed by PLAN-0008 | Run repeated DeepSeek benchmarks for fixtures 06–10 and record latency/token/semantic plus visual-descriptor validation | Repeated benchmark evidence, strict-output decision, ingredient identity and package-confidence thresholds | 2026-08-02 |
| [PLAN-0008](plans/PLAN-0008-define-lean-launch-ai-economics.md) | Define Lean Launch, Acquisition, AI Unit Economics, and Monetization | Operations | Ready | [Merged via PR #29](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/29) (`1115ba4`); Phase 1 assignment open | Unassigned launch, growth, and AI-economics agent | `main` / PR #29 | Thumbnail amendment on main reconciles Nano Banana 2 Lite evaluation, PLAN-0017 `thumbnailVisual`, cache-first generation, storage, budgets, privacy, evaluation and degraded behavior | Assign PLAN-0008 Phase 1 to refresh provider pricing/terms, provider-data policy, object-storage economics and measurable release thresholds | No documentation blocker; production image calls require implementation plans, AI Gateway controls, storage lifecycle, budgets and independent validation | 2026-08-02 |
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Ready | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | PLAN-0016 Completed after follow-up tip `0c6ac53cdd021bec343914214134721bb7a26fd6` | Claim plan and implement Phase 1 + mock-backed Phase 2 | Live menu/profile/recommendation contracts still required for live phases | 2026-08-02 |
...
|---|---|---|---|---|---|
| [PLAN-0016](plans/PLAN-0016-implement-production-session-and-inventory-frontend.md) | Implement Production Session and Authenticated Inventory Frontend | Implementation | [PR #25](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/25) ready for review @ `0c6ac53cdd021bec343914214134721bb7a26fd6` | **Completed** after follow-up semantic fingerprint + history-reload fixes. CI: Backend `30748795864`, Frontend `30748795883`, PLAN-0005 `30748795872`. Evidence `docs/evidence/plan-0016/pr25-final-review-remediation/follow-up-semantic-fingerprint-and-history-reload.md`. PLAN-0018 Fail on `814af25` immutable. | 2026-08-02 |
| [PLAN-0018](plans/PLAN-0018-independent-retest-plan-0016.md) | Independently Retest PLAN-0016 Authenticated Inventory Remediations | Testing | [Draft PR #27](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/27) → PLAN-0016 branch | **Fail**. SUT `814af25`. #20/#24 look remediated; #21/#22 pointer Failed at native 200%; #26 High isolation 412-vs-404. PLAN-0005 remains Conditional Pass. Evidence under `docs/evidence/plan-0018/`. Later remediations independently Pass under PLAN-0016 tip `38e5edfb49407d895995e0cf1b49054dc7ce5c5b` (does not rewrite this Fail). | 2026-08-02 |
| [PLAN-0005](plans/PLAN-0005-test-authenticated-inventory-slice.md) | Independently Validate the Authenticated Inventory Slice | Testing | **Merged** via [PR #19](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/19) at `60d98dd9e2e7c460d670e701c027a44f25cdfedc` (2026-08-01) | **Conditional Pass** (historical at merge). Residual #20/#21/#22/#24/#26 independently Pass on PLAN-0016 tip `38e5edfb49407d895995e0cf1b49054dc7ce5c5b` and issues closed; PLAN-0005 outcome string not rewritten to Pass. | 2026-08-01 |
