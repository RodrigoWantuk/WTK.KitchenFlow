...
|---|---|---|---|---|---|
| [PLAN-0028](plans/PLAN-0028-implement-recipe-ai-gateway-and-generation.md) | Implement Recipe AI Gateway and Cook-Now Generation Vertical Slice | Implementation | [PR #44](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/44) Ready for owner review | **Completed** — AI Gateway, DeepSeek adapter, usage ledger, cook-now sessions/candidates/expansion, persisted revisions, production Recipes UI, OpenAPI/clients; Fake-only focused tests; no live provider campaign rerun | 2026-08-05 |
