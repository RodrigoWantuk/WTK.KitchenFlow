...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0016](plans/PLAN-0016-implement-production-session-and-inventory-frontend.md) | Implement Production Session and Authenticated Inventory Frontend | Implementation | Validating | [PR #25](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/25) — final-review P1/P2 remediated; awaiting exact-tip CI | agent:composer-plan-0016 | `agent/plan-0016-production-inventory-frontend` | Local gates green (Backend 204, frontend 134 tests, Firefox zoom) | Await GHA Backend/Frontend/PLAN-0005; then Completed | Exact-tip CI | 2026-08-02 |
...
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Ready | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | Waiting on PLAN-0016 re-completion after PR #25 final-review remediation | Claim after PLAN-0016 returns to Completed | PLAN-0016 In Progress (PR review remediation) | 2026-08-02 |
