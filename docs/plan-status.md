...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0015](plans/PLAN-0015-remediate-frontend-baseline.md) | Remediate and Validate the Imported Frontend Baseline | Implementation | Validating | [PR #18](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/18) open; impl [Merged via PR #16](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/16) (`e248126`) | Cursor agent (PLAN-0015) | `docs/complete-plan-0015-validation` | Fail-closed zoom 22/22 Passed locally; validator OK; awaiting Frontend CI green | Confirm CI green → mark Completed; owner review/merge PR #18; do not start PLAN-0005 | Frontend CI on exact head | 2026-08-01T15:20:00Z |
| [PLAN-0005](plans/PLAN-0005-test-authenticated-inventory-slice.md) | Independently Validate the Authenticated Inventory Slice | Testing | Ready | Not started | Unassigned independent test agent | `agent/plan-0005-test-inventory-slice` (create after PLAN-0015 completion docs merge) | PLAN-0015 Validating on PR #18; frontend pin `e248126`; inventory/profile baselines on main | After PR #18 merge: independent agent claims plan, exclusive branch, move In Progress | Wait for owner merge of PR #18 (PLAN-0015 completion) | 2026-08-01T15:20:00Z |
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Blocked | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | Blocked by PLAN-0005; PLAN-0015 still Validating on PR #18 | Do not start until PLAN-0015 docs merged and PLAN-0005 automated P0 progress without Critical defects | PLAN-0005 automated validation of authenticated flow | 2026-08-01T15:20:00Z |
