...
|---|---|---|---|---|---|
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) · [amendment](plans/PLAN-0011-amendment-2026-08-02-next-execution.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Draft [PR #34](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/34) (awaiting owner merge) | Phase 1+2 + remediations + chooser definition contract hardening; Frontend `30763598158` + PLAN-0005 `30763598175` green on `9017e7e` | 2026-08-02 |
