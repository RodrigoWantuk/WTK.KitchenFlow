...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) · [amendment](plans/PLAN-0011-amendment-2026-08-02-next-execution.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Validating | Draft [PR #34](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/34) | Cursor agent (PLAN-0011 Phase 1 + Phase 2) | `agent/plan-0011-contextual-home` @ `76e4f962bfc011531fc1f83aa4a41bbf53a1dfff` | Phase 1+2 + CI green (Frontend `30752619945`, PLAN-0005 `30752619970`); draft awaiting owner | Owner review; no agent merge; live sources = PLAN-0021 | None for amended scope | 2026-08-02 |
