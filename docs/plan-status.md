...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0020](plans/PLAN-0020-implement-profile-household-equipment-frontend.md) | Implement Profile, Household, Preferences, and Equipment Frontend | Implementation | In Progress | Draft PR pending | Cursor agent (PLAN-0020 profile frontend) | `agent/plan-0020-profile-frontend` · functional `4ddc874` | Functional tip recorded | Open draft PR; await exact-head CI | None | 2026-08-03 |
