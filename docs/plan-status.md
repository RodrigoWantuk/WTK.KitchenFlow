...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0015](plans/PLAN-0015-remediate-frontend-baseline.md) | Remediate and Validate the Imported Frontend Baseline | Implementation | In Progress | Branch open | Cursor agent | `agent/plan-0015-remediate-frontend-baseline` | Governance/docs starting after PR #14/#15 on main | Implement prototype/production composition roots | None | 2026-07-31T22:47:18Z |
