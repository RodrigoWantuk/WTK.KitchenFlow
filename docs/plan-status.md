...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0014](plans/PLAN-0014-integrate-emergent-frontend.md) | Integrate Emergent Frontend and Establish Production Frontend Baseline | Implementation | Validating | [Draft PR #14](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/14) | Cursor agent | `agent/plan-0014-integrate-emergent-frontend` / #14 | Draft PR open; local typecheck/lint/test/build green | Owner review and merge decision after CI | None | 2026-07-31T22:05:00Z |
