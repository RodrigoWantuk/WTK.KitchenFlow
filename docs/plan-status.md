...
| [PLAN-0023](plans/PLAN-0023-implement-prepared-components-and-derived-lots.md) | Implement Prepared Components and Derived Inventory Lots | Implementation | In Progress | Draft PR pending first claim push | Codex backend/domain implementation agent | `agent/plan-0023-prepared-component-lots` | Claimed from `f166ce21020f6704d3fcd99b4b6d195b33638155`; PLAN-0026 Draft placeholder created | Define preparation domain/application contract and implement atomic persistence | None; preserve unrelated untracked workspace artifacts | 2026-08-04T01:24:28Z |
