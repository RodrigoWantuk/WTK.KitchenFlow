...
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Ready | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | Waiting on PLAN-0016 re-completion after PR #25 follow-up remediation | Claim after PLAN-0016 returns to Completed | PLAN-0016 In Progress (PR follow-up) | 2026-08-02 |
