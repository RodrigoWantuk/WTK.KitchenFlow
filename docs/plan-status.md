...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0005](plans/PLAN-0005-test-authenticated-inventory-slice.md) | Independently Validate the Authenticated Inventory Slice | Testing | Validating | Draft PR [#19](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/19) — changes requested (evidence integrity) | Independent testing agent | `agent/plan-0005-test-inventory-slice` | Evidence integrity corrective round: Provisional Conditional Pass until rewritten tip CI green (SHA identity, outage serialization, absolute evidence paths, consistency gates, historical P1 console rename, gitleaks history rewrite, container/PG metrics, #21/#22 repro text, reconciled counts) | Finish rewrite + force-with-lease; wait Backend/Frontend/PLAN-0005/secret-scan; then Completed Conditional Pass + owner re-review. No merge. No PLAN-0011. | Evidence package integrity (stale heads / empty outage snapshots / historical Failed console / whole-commit gitleaks allowlist) | 2026-08-01 |
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Blocked | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | PLAN-0005 returned to Validating for evidence integrity; residual High #20 still relevant | Owner decides whether to start after PLAN-0005 Conditional Pass + review of PR #19 / #20 | PLAN-0005 not Completed; residual High #20 | 2026-08-01 |
