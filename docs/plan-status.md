...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0020](plans/PLAN-0020-implement-profile-household-equipment-frontend.md) | Implement Profile, Household, Preferences, and Equipment Frontend | Implementation | Validating | Draft [PR #35](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/35) remediation candidate `06bd95b` | PLAN-0020 remediation agent | `agent/plan-0020-profile-frontend` / #35 | Exact-head Frontend `30857947860` + PLAN-0005 `30857947726` Passed | Independent PLAN-0025 retest against `06bd95b` | #37 awaiting independent retest | 2026-08-03 |
| [PLAN-0025](plans/PLAN-0025-independently-retest-plan-0020-profile-remediation.md) | Independently Retest PLAN-0020 Profile Remediation | Testing | In Progress | Claim evidence package created; validation PR pending | Independent testing agent (PLAN-0025) | `agent/plan-0025-retest-plan-0020-profile` | Immutable SUT `06bd95b` verified; detached SUT worktree created; exact candidate CI passed | Open draft PR and execute independent F-0024-01…05 plus non-regression matrix | None | 2026-08-03 |
...
|---|---|---|---|---|---|
| [PLAN-0024](plans/PLAN-0024-independently-validate-plan-0020-profile-frontend.md) | Independently Validate PLAN-0020 Profile Frontend | Testing | Draft [PR #36](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/36) (immutable Fail evidence) | **Fail** at SUT `5733bb4de957b53469a28bc60c472a90f0955907` (P1 F-0024-01/02); evidence tip `b549a97` | 2026-08-03 |
