...
| [PLAN-0023](plans/PLAN-0023-implement-prepared-components-and-derived-lots.md) | Implement Prepared Components and Derived Inventory Lots | Implementation | In Progress | Draft [PR #39](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/39) | Codex backend/domain implementation agent | `agent/plan-0023-prepared-component-lots` | Declared yield is now immutable batch history; same-key adjustment replay, null transport collections, and bounded set-based provenance are corrected and focused-tested | Complete migration/API/client and repeated-concurrency validation, then publish replacement candidate | Exact-head CI is pending; PLAN-0026 remains unpinned | 2026-08-05T00:05:00Z |
| [PLAN-0026](plans/PLAN-0026-independently-validate-prepared-components.md) | Independently Validate Prepared Components and Derived Lots | Testing | Draft | Not started | Unassigned independent testing agent | `agent/plan-0026-validate-prepared-components` | Prior SUT unpinned and superseded; no independent test started | Await a replacement green PLAN-0023 candidate | Replacement candidate and exact-head CI pending | 2026-08-04T23:00:00Z |
