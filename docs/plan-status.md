...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0005](plans/PLAN-0005-test-authenticated-inventory-slice.md) | Independently Validate the Authenticated Inventory Slice | Testing | Validating | Draft PR [#19](https://github.com/RodrigoWantuk/WTK.KitchenFlow/pull/19) — raw vs docs separation | Independent testing agent | `agent/plan-0005-test-inventory-slice` | Provisional Conditional Pass; staging raw-only artifacts | Wait clean CI; docs-only pin of evidenceGenerationHead; Completed | Raw artifacts previously mixed static docs/historical files | 2026-08-01 |
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Blocked | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | PLAN-0005 Validating (raw artifact separation); residual High #20 | Owner decides after PLAN-0005 Completed | PLAN-0005 Validating; residual High #20 | 2026-08-01 |
