...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0015](plans/PLAN-0015-remediate-frontend-baseline.md) | Remediate and Validate the Imported Frontend Baseline | Implementation | Validating | Merged via PR #16 (`e248126`) | Cursor agent | `agent/plan-0015-remediate-frontend-baseline` (merged) | Code merged; remaining owner/manual validation (real browser zoom 200%; full NVDA/VoiceOver optional/later) | Owner records manual validation decision or Completes PLAN-0015 | Remaining concrete manual frontend validation (200% zoom; AT audit decision) | 2026-08-01T13:50:00Z |
| [PLAN-0005](plans/PLAN-0005-test-authenticated-inventory-slice.md) | Independently Validate the Authenticated Inventory Slice | Testing | Ready | Not started | Unassigned independent test agent | `agent/plan-0005-test-inventory-slice` (create when unblocked) | Baselines available on main: inventory PLAN-0003; profile `49985f9` (PR #12); frontend candidate `e248126` (PR #16) — not definitive until PLAN-0015 manual decision | After owner decides PLAN-0015 manual validation, pin frontend SHA, create exclusive branch, move In Progress | Remaining PLAN-0015 manual validation before definitive frontend pin | 2026-08-01T13:50:00Z |
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Blocked | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | PLAN-0015/0012 merged; wait for PLAN-0015 acceptance and sufficient PLAN-0005 independent validation | Do not start before PLAN-0015 acceptance and PLAN-0005 progress without critical authenticated-flow defects | PLAN-0015 formal acceptance; PLAN-0005 independent validation of authenticated flow | 2026-08-01T13:50:00Z |
