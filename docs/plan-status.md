...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) · [amendment](plans/PLAN-0011-amendment-2026-08-02-next-execution.md) | Implement the Public Entry and Contextual Home Experience | Implementation | In Progress | Draft [PR #34](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/34) | Cursor agent (PLAN-0011 contract hardening) | `agent/plan-0011-contextual-home` · functional `9079887` | Contract hardening functional tip recorded | Await exact-head Frontend + PLAN-0005; mark Completed when green | Exact-head CI pending | 2026-08-02 |
