...
|---|---|---|---|---|---|
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) · [amendment](plans/PLAN-0011-amendment-2026-08-02-next-execution.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Draft [PR #34](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/34) awaiting owner merge | Amended Phase 1+2 Completed: public entry without session bootstrap; mock contextual home; local+CI green on `c895b4c`; live sources deferred to PLAN-0021 | 2026-08-02 |
