...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) · [amendment](plans/PLAN-0011-amendment-2026-08-02-next-execution.md) | Implement the Public Entry and Contextual Home Experience | Implementation | In Progress | Branch claimed; draft PR pending | Cursor agent (PLAN-0011 Phase 1 + Phase 2) | `agent/plan-0011-contextual-home` | Claimed from `main` (`444969c` / PR #33). Substantial run: Phase 1 public entry + Phase 2 mock-backed home only | Implement presentation models, entry + home UI, mock/unavailable adapters, i18n, tests, draft PR | None for amended scope; live contracts = PLAN-0021 | 2026-08-02 |
