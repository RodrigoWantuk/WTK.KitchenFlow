...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0016](plans/PLAN-0016-implement-production-session-and-inventory-frontend.md) | Implement Production Session and Authenticated Inventory Frontend | Implementation | Validating | [Draft PR #25](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/25) — rebased onto `main` (`1115ba4`); awaiting single-tip revalidation | agent:composer-plan-0016 | `agent/plan-0016-production-inventory-frontend` | Merged `origin/main` (PLAN-0017 #31 + PLAN-0008 #29); PR #23 closed/superseded | Run Backend/Frontend/PLAN-0005 + independent retest on exact tip; then Completed | None for coding | 2026-08-02 |
...
| [PLAN-0011](plans/PLAN-0011-implement-entry-and-contextual-home.md) | Implement the Public Entry and Contextual Home Experience | Implementation | Blocked | Not started | Unassigned frontend/product implementation agent | `agent/plan-0011-contextual-home` | Waiting on PLAN-0016 independent retest Pass/Conditional Pass after remediations | Do not start until PLAN-0016 completes independent retest | PLAN-0016 Validating pending retest | 2026-08-02 |
