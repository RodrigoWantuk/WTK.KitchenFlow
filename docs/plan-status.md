...
| [PLAN-0023](plans/PLAN-0023-implement-prepared-components-and-derived-lots.md) | Implement Prepared Components and Derived Inventory Lots | Implementation | In Progress | Draft [PR #39](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/39) | Codex backend/domain implementation agent | `agent/plan-0023-prepared-component-lots` | Focused PostgreSQL rollback/concurrency/replay, migration, contract/client, frontend, telemetry, and Keycloak checks passed | Run the full Backend workflow on a clean Docker host or exact-head CI, then record candidate evidence | Local Docker pauses/recycles Testcontainers PostgreSQL during the complete assembly; preserve unrelated untracked workspace artifacts | 2026-08-04T22:12:24Z |
