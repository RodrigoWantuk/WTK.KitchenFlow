...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0015](plans/PLAN-0015-remediate-frontend-baseline.md) | Remediate and Validate the Imported Frontend Baseline | Implementation | Validating | Draft PR pending owner review | Cursor agent | `agent/plan-0015-remediate-frontend-baseline` | Remediations implemented; awaiting owner review | Owner reviews draft PR (no agent merge) | Owner merge authorization | 2026-07-31T23:15:00Z |
