...
|---|---|---|---|---|---|---|---|---|---|---|
| [PLAN-0020](plans/PLAN-0020-implement-profile-household-equipment-frontend.md) | Implement Profile, Household, Preferences, and Equipment Frontend | Implementation | In Progress | Draft [PR #35](https://github.com/RodrigoWantuk/WTK.Cocinaris/pull/35) | Cursor agent (PLAN-0020 profile frontend) | `agent/plan-0020-profile-frontend` · functional `4ddc874` | Functional tip recorded | Open draft PR; await exact-head CI | None | 2026-08-03 |
| [PLAN-0024](plans/PLAN-0024-independently-validate-plan-0020-profile-frontend.md) | Independently Validate PLAN-0020 Profile Frontend | Testing | Draft | Not started | Unassigned independent testing agent | `agent/plan-0024-validate-plan-0020-profile` | Placeholder created at PLAN-0020 claim | Claim after PLAN-0020 publishes a stable candidate SHA | PLAN-0020 candidate SHA | 2026-08-03 |
