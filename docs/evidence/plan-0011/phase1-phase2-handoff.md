...
| CI-validated tip | pending exact-head Frontend + PLAN-0005 on published head |
| Current PR head reported in PR metadata | see published branch tip after this packaging commit |
